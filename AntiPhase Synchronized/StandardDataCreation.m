%%
load(['AntiphaseInitials_',num2str(Coplng_coeff),'.mat']);
%%
Ti=0;Tf=50;Ntme=(Tf*100000)+1;
...
Vstd=V(1,iio:(iio+iip));
Mstd=M(1,iio:(iio+iip));
Nstd=N(1,iio:(iio+iip));
Hstd=H(1,iio:(iio+iip));
